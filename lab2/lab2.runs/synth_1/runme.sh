...
HD_PWD='C:/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_of_minterms.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_of_minterms.tcl
